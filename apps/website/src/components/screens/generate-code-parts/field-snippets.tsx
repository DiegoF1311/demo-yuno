...
export const generateCodeSnippetWithField = (
  field: FormFieldType,
  library: FormLibrary,
): string => {
...
const generateInputWithField = (
  ...
  <Input 
    ...
    ${field.disabled ? "disabled" : ""}
    ${
      library === FORM_LIBRARIES.TANSTACK_FORM
...
const generateTextareaWithField = (
  field: FormFieldType,
  library: FormLibrary,
): string => {
  if (library === FORM_LIBRARIES.REACT_HOOK_FORM) {
...
const generateCheckboxWithField = (
  field: FormFieldType,
  library: FormLibrary,
): string => {
  if (library === FORM_LIBRARIES.REACT_HOOK_FORM) {
...
const generateDefaultFieldWithField = (
  field: FormFieldType,
  library: FormLibrary,
): string => {
  if (library === FORM_LIBRARIES.REACT_HOOK_FORM) {
